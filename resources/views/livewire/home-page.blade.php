<div>
<div class="w-full h-screen bg-gradient-to-r from-gray-300 to-gray-600 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    <!-- Grid -->
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Make the Memories with <span class="text-gray-600">Ko-La Self</span></h1>
        <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">
        Abadikan momen spesialmu bersama Ko-La Self—studio foto self-service favorit di Jember dengan ruangan yang nyaman, pencahayaan profesional, dan hasil digital instan
</p>


        <!-- Buttons -->
        <div class="mt-7 grid gap-3 w-full sm:inline-flex">
          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gray-600 text-white hover:bg-gray-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
            Mulai
      ...
      <div class="relative ms-9 animate-fadeIn">
      <img class="w-full rounded-md transition-transform duration-500 hover:scale-105" src="{{ asset('storage/logo.png') }}" alt="Image Description">
...
<section class="py-20">
    ...
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        ...
        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
          ...
          <div class="flex-1 h-2 bg-gray-400">
          </div>
          <div class="flex-1 h-2 bg-gray-600">
          </div>
        </div>
      </div>
  ...
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
      ...
      @foreach ($paketfoto as $paketfoto)
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $paketfoto->id }}">
          <a href="#" class="">
            <img src="{{ url('storage', $paketfoto->gambar) }}" alt="{{ $paketfoto->nama_paket_foto }}" class="object-cover w-full h-64 rounded-t-lg">
          </a>
...
<section class="py-16 px-4">
  <div class="max-w-6xl mx-auto text-center">
    <h2 class="text-4xl font-bold mb-4 flex justify-center items-center gap-2">
      <span>Galeri Hasil Foto Customer</span>
    </h2>
    <p class="text-lg text-gray-600 mb-8">
      Kumpulan foto-foto indah dari customer kami yang puas dengan layanan kami
    </p>

    

    <!-- Galeri Grid -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="galeri">
      <!-- Gambar -->
      <div class="galeri-item pasangan">
        <img onclick="openModal(this.src)" src="{{ asset('storage/3.webp') }}" alt="Pasangan" class="rounded-xl w-full object-cover hover:scale-105 transition-transform duration-300 cursor-pointer">
      </div>
      <div class="galeri-item anak">
        <img onclick="openModal(this.src)" src="{{ asset('storage/1.webp') }}" alt="Anak" class="rounded-xl w-full object-cover hover:scale-105 transition-transform duration-300 cursor-pointer">
      </div>
      <div class="galeri-item keluarga">
        <img onclick="openModal(this.src)" src="{{ asset('storage/2.webp') }}" alt="Keluarga" class="rounded-xl w-full object-cover hover:scale-105 transition-transform duration-300 cursor-pointer">
      </div>
      <div class="galeri-item portrait">
        <img onclick="openModal(this.src)" src="{{ asset('storage/pasangan.jpg') }}" alt="Portrait" class="rounded-xl w-full object-cover hover:scale-105 transition-transform duration-300 cursor-pointer">
      </div>
      <div class="galeri-item anak">
        <img onclick="openModal(this.src)" src="{{ asset('storage/IBS_7497.JPG') }}" alt="Anak-anak" class="rounded-xl w-full object-cover hover:scale-105 transition-transform duration-300 cursor-pointer">
      </div>
      <div class="galeri-item pasangan">
        <img onclick="openModal(this.src)" src="{{ asset('storage/4.jpeg') }}" alt="Pasangan" class="rounded-xl w-full object-cover hover:scale-105 transition-transform duration-300 cursor-pointer">
      </div>
    </div>
  </div>
</section>
